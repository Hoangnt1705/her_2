...
<div class="wrap-sidebar">
    <div id="sidebar" class:hidden={!$sidebar} transition:slide={{ duration: 200, quintOut: quintOut }}>
        <div class="float-top">
        ...
        <li class="inline-flex items-center text-sm font-medium text-gray-800 my-1"  animate:flip in:receive={{ key: chat._id }} out:send={{ key: chat._id }} id="chat-{chat._id}">
