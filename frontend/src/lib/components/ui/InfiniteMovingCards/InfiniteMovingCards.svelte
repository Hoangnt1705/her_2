<script>
    ...
    export let items = []; // Array of objects containing quote, name, and title
    export let direction = 'left'; // Default to 'left'
    export let speed = 'fast'; // Default to 'fast'
    export let pauseOnHover = true; // Default to true
    export let className = undefined; // Optional className
