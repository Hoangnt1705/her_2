...
<TailwindCSS />
<div
  class="flex items-center justify-center space-x-4 user-menu"
  ...
  <div
    ...
    class="dropdown-menu rounded-xl shadow-lg bg-white absolute top-10
    -translate-y-40 w-60 mt-2 open"
    ...
    <ul class="py-2">
      ...
      <li>
        <a
          class="block px-6 py-2 hover:bg-gray-100 text-red-500 font-medium"
